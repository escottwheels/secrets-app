    ...
    return (
        <>
            <button
                ...
                className="z-10 absolute top-8 right-0 transform-gpu transition-all mr-20 rounded-xl bg-cobalt-midnight border border-white font-semibold text-white px-3 py-2 duration-300 ease-out hover:-translate-y-1 hover:bg-yellow-400"
            >
                ...
                <div className="bg-cobalt-midnight flex flex-col justify-around z-0 absolute w-64 h-screen top-0 right-0 px-3 py-2">
                    <div>
                        ...
                        <input name="first" id="first" autoFocus placeholder={"Enter your first name"} defaultValue={user.firstName}
                            className="focus:outline-none w-full p-1 border rounded-xl" />
                        <div className="mt-4 flex justify-center">
                            <input name="last" id="last" placeholder={"Enter your last name"} defaultValue={user.lastName}
                                className="w-full focus:outline-none p-1 border rounded-xl" />
                            <button type="submit"><CheckIcon className="cursor-pointer border border-white hover:border-0 bg-cobalt-midnight rounded-xl hover:bg-yellow-400 hover:-translate-y-1  duration-300 ease-in-out p-1 ml-2 text-white h-8 inline" /></button>
                        </div>
